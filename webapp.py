...
with st.form("form_mediciones", clear_on_submit=True):
    ...
    with col_izq:
        ...
        alim_l1_l2 = st.text_input("Ais. Alim L1-L2 (MΩ)")
        alim_l1_l3 = st.text_input("Ais. Alim L1-L3 (MΩ)")
        alim_l2_l3 = st.text_input("Ais. Alim L2-L3 (MΩ)")
        alim_l1_t = st.text_input("Ais. Alim L1-T (MΩ)")
        alim_l2_t = st.text_input("Ais. Alim L2-T (MΩ)")
        alim_l3_t = st.text_input("Ais. Alim L3-T (MΩ)")
        st.write("")
        volt_l1 = st.text_input("Volt L1-T (V)")
        volt_l2 = st.text_input("Volt L2-T (V)")
        volt_l3 = st.text_input("Volt L3-T (V)")
        volt_l1_l2 = st.text_input("Volt L1-L2 (V)")
        volt_l1_l3 = st.text_input("Volt L1-L3 (V)")
        volt_l2_l3 = st.text_input("Volt L2-L3 (V)")
